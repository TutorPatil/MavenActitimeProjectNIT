...
public class BaseClass implements ITestListener{
	...
	{
		writeLogs("*** This method will run before every Test case*****");
		writeLogs("Starting the method launchApplication");
		...
		writeLogs("Launched the application...Ending the method launchApplication");
	}
	...
	{
		writeLogs("*** This method will run after every Test case*****");
		driver.quit();
	}
	...
	public void onStart(ITestContext context) 
	{
		...
		File f1 = new File("./src/test/results/logs.txt");
	...
	public void onFinish(ITestContext context) {
		System.out.println(" ##### This is a listener method and this will run in at the end of entire suite####");
	}	
	public void onTestStart(ITestResult result) {	
		try {
			writeLogs(" Starting the test case "+result.getName());
		} catch (IOException e) {		
			e.printStackTrace();
		}	
	}
	...
	public void onTestFailure(ITestResult result) {
		try {
			System.out.println("###### The Test case by name "+result.getName()+" is getting Failed ###");
